...
namespace win
{
	...
	union section_characteristics_t
	{
		...
		inline void set_alignment( uint32_t a ) { alignment = a == 0x10 ? 0x0 : _tzcnt_u64( a ) + 1; }
	};
	...
	struct dos_header_t
	{
		...
		template<bool x64> inline auto get_nt_headers() { return ( nt_headers_t<x64>* ) ( ( uint8_t* ) this + e_lfanew ); }
	};
